...
namespace TidalLib
{
    public class Client
    {
        ...
        private static Dictionary<string, string> API_KEY = new Dictionary<string, string>() { { "clientId", "COFVfUXkiLTN3lAe" } , { "clientSecret", "DzcOwwEiEWPtMj4RXQ4Y2EwGIKWMGiV05KCQuqhXdzU=" } };
